...
public class Main {
    ...
    private static final String MARKET = "PL";
    private static final String EXCHANGE = "GPW";
    private static final String SYMBOL = "GPW:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"GPW:000040\",\"GPW:005930\"],\"replay\":\"last\"}";

...
Kun Data provides real-time market data for Poland through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Poland market coverage with support for GPW.

## API Capabilities

- Real-time WebSocket market data for Poland
...
This repository is designed to make Poland market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/poland-stock-market-api
